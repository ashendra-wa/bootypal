...
const ButtonContainer = styled.div`
  .ant-btn-primary {
    background: linear-gradient(to bottom, #C78BE1, #F7A8B8) !important;
  }
  .ant-btn-success {
...
const credit = [
  ...
  >
    <path
      fill="linear-gradient(to bottom, #C78BE1, #F7A8B8)"
              ...
              <div className="sidebar-color">
                ...
                <div className="theme-color mb-2">
                  <ButtonContainer>
                    <Button
                      type="primary"
                      onClick={() => handleSidenavColor("linear-gradient(to bottom, #C78BE1, #F7A8B8)")}
                    >
                      1
                    </Button>
                    <Button
          ...
          <Link to="/profile" className="btn-sign-in">
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
              <div style={{
                ...
                <img
                  src={localStorage.getItem('photo') ? baseUrl+'/'+localStorage.getItem('photo') : '/avatar.jpg'}
                  alt="Profile"
