                ...
                <Row gutter={[24, 0]}>
                    <Col xs="24" xl={24}>
                        <Card
                            ...
                            extra={
                                <>
                                    <Link className="custom-btn" to="/faq/add">Add</Link>
                                </>
                            }
                        >
                            <div className="table-responsive">
                                <Table
                                    ...
                                    dataSource={userList.map((user, index) => ({
                                        ...
                                        description: (
                                            <Button type="primary" onClick={() => showModal(user.answer, 'Description')}>
                                                <EyeOutlined />
                                            </Button>
                                        ),
                                        status: (
                                        ...
                                        action: (
                                            <div className="button-container">
                                                <Link to={`/faq/update/${user._id}`} className="update-btn">
                                                    <EditOutlined />
                                                </Link>
