  ...
  async function handleDeactivateUser(userId, status) {
    try {
      ...
      const response = await axios.patch(
        `${baseUrl}/api/admin/status/${userId}?enabled=${status}`,
        {
          headers: {
              ...
              <div className="table-responsive">
                <Table
                  ...
                  dataSource={userList.map((user, index) => ({
                    key: index.toString(),
                    name: <UserAvatar user={user} baseUrl={baseUrl} />,
                    phoneNumber: (
                    ...
                    status: (
                      <span
                        className={
                          user?.user?.enabled ? "text-success" : "text-danger"
                        }
                      >
                      ...
                      <div>
                        {user?.user?.enabled ? (
                          <Button
                            type="danger"
                            onClick={() =>
                              handleDeactivateUser(user?.user?._id, false)
                            }
                          >
                            Deactivate
                          </Button>
                          ...
                          <Button
                            type="primary"
                            onClick={() =>
                              handleDeactivateUser(user?.user?._id, true)
                            }
                          >
                            Activate
                          </Button>
